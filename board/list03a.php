...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
	...
	<tr>
		<td style="border:1px solid #bcbcbc; border-left:0px; border-right:0px; background-color:#f6f6f6; padding:15px 0px; text-align:center;">
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr align='center'>
					<td width="10%"><input name='all_chk' type='checkbox' onclick="All_chk('all_chk','chk[]');"></td>
					<td width="10%" class='b-text'>번호</td>
...
?>
				<tr <?=$bgcolor?> height='45'> 
					<td width="10%" class='b-text-s' align='center'>
				...
				<tr>
					<td colspan="100" height="1px" style="border-bottom:1px solid #ddd;"></td>
				</tr>
