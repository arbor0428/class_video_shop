		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr align="" height='30'>
					...
					<th width="100" class='bbs'>Writer</th>
					<th width="*" class='bbs'>Tittle</th>
					<?
					...
					?>
						<th width="250" class='bbs'>Filing date</th>
						<th width="250" class='bbs'>Registration date</th>
					<?
						}
					?>

					<th width="160" class='bbs'>Registration date</th>
				</tr>
