	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr align="" height='50'>							
					<th width="20%" class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">등록(출원)번호</th>
					<td class='bbs01' style="padding-left:2%; box-sizing:border-box;"><?=$title?></td>
				</tr>
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">출원일</th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;"><?=$data03?></td>
				</tr>
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">등록일</th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;"><?=$data04?></td>
				</tr>

				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">특허(출원)명칭</th>
...
?>
				...
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">첨부파일#<?=$fno?></th>
