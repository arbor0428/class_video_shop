...
<table class="viewTbl" width="100%" border="0" cellspacing="0" cellpadding="0" style='background:#ffffff;'>
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr height="300" valign="top">
					<td class='bbs01' colspan='5' style="padding:30px 20px;" id='ment'><?=$ment?></td>
				</tr>
