...
function check_form(){
	...
	if(isFrmEmptyModal(form.data01,"업체명을 입력해 주십시오"))	return;
	if(isFrmEmptyModal(form.data02,"일반전화를 입력해 주십시오"))	return;
	if(isFrmEmptyModal(form.data03,"휴대전화를 입력해 주십시오"))	return;
	if(isFrmEmptyModal(form.data04,"이메일을 입력해 주십시오"))	return;
...
<div style='margin:10px auto;text-align:right;font-size:0.875rem'><span class="eq"></span>표시된 항목은 필수항목입니다.</div>
...
?>
				...
				<div class="tbl-st-row clearfix"> 
					<div class="tbl-st-col col-1"><span class="eq"></span>제목</div>
				...
				<div class="tbl-st-row-wrap clearfix">
					<div class="tbl-st-row clearfix"> 
						<div class="tbl-st-col col-1"><span class="eq"></span>작성자</div>
						<div class="tbl-st-col col-2"><input name="name" id="user_name" type="text" style='width:98%;' value="<?=$name?>"></div>
					</div>
					<div class="tbl-st-row clearfix"> 
						<div class="tbl-st-col col-1"><span class="eq"></span>업체명</div>	
