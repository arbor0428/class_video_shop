<?
	...
	if($uid){
		...
		if($site=='재단'){
			$ment = str_replace("/smarteditor/upload/","https://ansanyouth.or.kr/smarteditor/upload/",$ment);
		}elseif($site=='상록'){
			$ment = str_replace("/smarteditor/upload/","https://sangnok.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='단원'){
			$ment = str_replace("/smarteditor/upload/","https://danwon.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='일동'){
			$ment = str_replace("/smarteditor/upload/","https://ildong.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='사동'){
			$ment = str_replace("/smarteditor/upload/","https://sadong.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}elseif($site=='선부'){
			$ment = str_replace("/smarteditor/upload/","https://seonbu.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}elseif($site=='예절'){
			$ment = str_replace("/smarteditor/upload/","https://etiquette.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}
		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr height="300" valign="top">
					<td class='bbs01 ment' colspan='2' style="padding:30 0"><?=$ment?></td>
				</tr>
...
//수정 & 삭제버튼 설정
if($GBL_MTYPE){
	if(($GBL_MTYPE == 'A' && $site=='재단') || $GBL_USERID == $userid){
		$btn_tbl_type = 'ok';
