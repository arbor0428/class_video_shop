...
<table cellpadding='0' cellspacing='0' border='0' width='100%'>
	<tr>
		<td>
			<div style='width:32%;height:460px;background:#eeeeee;float:left;'><?=$userfile?></div>

			<table cellpadding='0' cellspacing='0' border='0' width='65%' class='zTable0' style='float:right;'>
				<tr>
					<th colspan='2' style='font-size:24px;letter-spacing:-1;padding-bottom:15px;border-bottom:1px solid #dddddd;'><?=$title?></th>
				</tr>
				<tr>
					<th style=''>장르</th>
					<td style=''><?=$sData01?></td>
				...
				<tr>
					...
					<td height='120' style='width:560px;background:#f7f7f7;letter-spacing:-0.5;border:1px solid #e3e3e3;padding:10px 15px;'><?=$sDataTxt?></td>
				</tr>
				<tr>
					<th>주최</th>
					<td><?=$sData05?></td>
			...
			?>
				<tr>
					<th>티켓</th>
					<td><a href="<?=$sDataUrl?>" target="_blank" class="small cbtn black">예매하기</a></td>
				</tr>
			<?
				}
			?>
				<tr>
					<th style='padding-bottom:10px;'>문의</th>
					<td style='padding-bottom:10px;'><?=$sData06?></td>
				</tr>
			</table>
		</td>
	</tr>
