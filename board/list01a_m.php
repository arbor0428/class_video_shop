	...
	<tr>
		<td style='padding:0 0 5px 0;'>
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				...
				?>
					<td align='center'>
						<select name="field" style='height:30px;border:1px solid #dddddd;border-radius:3px;padding:5px;box-sizing:border-box;'>
						...
						<input name="word" type="text" style='width:200px;height:30px;border:1px solid #dddddd;border-radius:3px;padding:5px;box-sizing:border-box;' value='<?=$word?>' onkeypress="if(event.keyCode==13){goSearch();}"> <a href="javascript:goSearch();" class="big cbtn black">검색</a>
					</td>
				</td>
			</table>
		</td>
		...
		<td style="border:1px solid #bcbcbc; border-left:0px; border-right:0px; background-color:#f6f6f6; padding:8px 0px; text-align:center;">
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr align='center'>
					...
					<td width="10%" class='b-text-s' align='center'>시설</td>
...
?>
				<tr <?=$bgcolor?> height='45'> 
					...
					<td width="10%" class='b-text-s' align='center'><?=$siteTxt?></td>
					...
					<td width="17%" class='b-text-s' align='center'>
						<?
							if($site=='재단'){						
						?>
						<a href="javascript:reg_modify('<?=$uid?>');"><img src="<?=$BTN_modify02?>" alt="수정"></a>
						<a href="javascript:click_del('<?=$title?>','<?=$uid?>')"><img src="<?=$BTN_del02?>" alt="삭제" width="50"></a>
						<?
							}					
						?>
					</td>
