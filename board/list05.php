...
?>
				<!-- 질문 -->
				<tr <?=$bgcolor?> height='65' class='<?=$qna_box?>'> 
					<td width='120' align='center'><img src="<?=$BTN_qimg?>"></td>
					<td width='1080' style='padding-left:5px;font-size:18px;'><?=$btn_tit_view?></td>
				...
				<tr id='a_line<?=$line_num?>' style="display:none" class='<?=$qna_box?>'> 
					<td bgcolor="cccccc"  height="1" colspan="<?=$cols?>"></td>
				</tr>

				<!-- 답변 -->
				<tr id='a_ment<?=$line_num?>' style="display:none" <?=$bgcolor?> class='<?=$qna_box?>'> 
					<td align='center' style='background:#f1f3f7'><img src="<?=$BTN_aimg?>"></td>
					<td style='padding:50px 5px;background:#f1f3f7' colspan='3'><span class='board1' style='line-height:20px;font-size:16px;'><?=$ment?></span></td>
				</tr>
				...
				<tr id='a_ment<?=$line_num?>' style="display:none" <?=$bgcolor?> class='<?=$qna_box?>'>
					<td align='center'></td>
					<td align='center'><img src="<?=$BTN_aimg?>"></td>
...
?>
				...
				<tr id='a_ment<?=$line_num?>' style="display:none" <?=$bgcolor?> class='<?=$qna_box?>'> 
					<td align='center' style='background:#f1f3f7'><img src="<?=$BTN_aimg?>"></td>
					<td style='padding:50px 5px;background:#f1f3f7' colspan='2'><span class='board1' style='line-height:20px;font-size:16px;'><?=$ment?></span></td>
				</tr>
...
?>
				...
				<tr> 
					<td style='padding-top:10px;' colspan="<?=$cols?>" align='right'><?=$btn_write?></td>
				</tr>
			</table>									
		</td>
	</tr>
