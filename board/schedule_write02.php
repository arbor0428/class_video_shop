...
<input type='hidden' name='data02' value="<?=$data02?>">
	...
	<tr>
		<td>
			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='gTable2'>
				...
				<tr> 
					<th><?=$ico01?> 이용시설</th>
					<td><input name="title" type="text" style='width:70%;' value="<?=$title?>"></td>
					<th><?=$ico01?> 대관자</th>
					<td><input name="sData01" type="text" style='width:70%;' value="<?=$sData01?>"></td>
				</tr>

				<tr> 
					<th width='17%'><?=$ico02?>대관일자</th>
					<td width='33%'><input type="text" name="sData02" value="<?=$sData02?>" style='width:70%;'></td>
					<th width='17%'><?=$ico02?>사용일자</th>
					<td width='33%'><input type="text" name="sData03" value="<?=$sData03?>" style='width:70%;'></td>
				</tr>

				<tr> 
					<th width='17%'><?=$ico02?>시간</th>
					<td width='33%'><input type="text" name="sData04" value="<?=$sData04?>" style='width:70%;'></td>
					<th width='17%'><?=$ico02?>사용인원</th>
					<td width='33%'><input type="text" name="sData05" value="<?=$sData05?>" style='width:70%;'></td>
				</tr>

				<tr> 
					<th width='17%'><?=$ico02?>결제수단</th>
					<td width='33%'><input type="text" name="sData06" value="<?=$sData06?>" style='width:70%;'></td>
					<th width='17%'><?=$ico02?>결제일</th>
					<td width='33%'><input type="text" name="sData07" value="<?=$sData07?>" style='width:70%;'></td>
				</tr>
