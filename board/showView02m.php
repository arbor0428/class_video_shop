<?
	...
	if($uid){
		...
		$userfile = "<img src='".$geturl."' style='width:100%;'>";
...
<table cellpadding='0' cellspacing='0' border='0' width='90%' style='margin:0 5%;'>
	<tr>
		<td>

			<div style='width:100%;height:auto;padding-bottom:20px;'><?=$userfile?></div>

			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='zTable'>
				<tr>
					<th colspan='2' style='font-size:18px;letter-spacing:-1;padding-bottom:10px;border-bottom:1px solid #dddddd;'><?=$title?></th>
				</tr>
				<tr>
					<th width='20%' style='padding-right;0 !important;'>장르</th>
					<td width='80%' style=''><?=$sData01?></td>
				</tr>
				<tr>
					<th>장소</th>
					<td><?=$sData02?></td>
				...
				<tr>
					<th valign='top' style='padding-top:12px;'>설명</th>
					<td height='120' style='background:#f7f7f7;letter-spacing:-0.5;border:1px solid #e3e3e3;padding:10px 15px;line-height:1.6 !important;'><?=$sDataTxt?></td>
				</tr>
				<tr>
					<th>주최</th>
					<td><?=$sData05?></td>
				...
				<tr>
					<th style='padding-bottom:15px;'>문의</th>
					<td style='padding-bottom:15px;'><?=$sData06?></td>
				</tr>
				<style>
				.zTable th{line-height:1 !important;}
				.zTable td{line-height:1 !important;}
