...
?>
				...
				<div class="tbl-st-row-wrap clearfix">
					<div class="tbl-st-row clearfix"> 
						<div class="tbl-st-col col-1">학술지 및 학회</div>
						<div class="tbl-st-col col-2"><input name="title" type="text" id='title' style='width:98%;' value="<?=$title?>"></div>
					</div>
					<div class="tbl-st-row clearfix"> 
				...
				<div class="tbl-st-row clearfix"> 
					<div class="tbl-st-col col-1">논문명</div>
