	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr align="" height='50'>							
					<th width="20%" class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">학술지 및 학회</th>
				...
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">논문명</th>
