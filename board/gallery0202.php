...
?>
					<a <?=$btn_link?>>
						...
						<div class='listName'><?=$data01?> / <?=$data02?></div>
...
?>
					...
					<p class="f16" style='padding:30px 0;'>등록된 실적이 없습니다.</p>
...
.listImg{
  ...
  overflow: hidden;
    ...
    .imgWrap > a:nth-child(1),.imgWrap > a:nth-child(2),.imgWrap > a:nth-child(3) {border-top:1px solid #d1d1d1;}
