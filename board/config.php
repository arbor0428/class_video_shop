...
if($list_mod == '리스트형'){
	...
	$record_count = 9;  //한 페이지에 출력되는 레코드수
	$link_count = 10; //한 페이지에 출력되는 페이지 링크수

	if($table_id=='table_1668642466' || $table_id=='table_1668642480' || $table_id=='table_1668647496' || $table_id=='table_1668647506' || $table_id=='table_1668647516' || $table_id=='table_1668647523' ){
		$record_count = 900;  //한 페이지에 출력되는 레코드수
	}
