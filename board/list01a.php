				...
				<table cellpadding='0' cellspacing='0' border='0' width='100%'>
					...
					<tr>
						<td align='right' style="padding-top: 2%; padding-bottom:1%;" class="selectwrap">
							...
							<input name="word" type="text" class="board-input" value='<?= $word ?>' onkeypress="if(event.keyCode==13){goSearch();}"> <a href="javascript:goSearch();" class="btn btn_board bora01 c_w">검색</a>
						</td>
