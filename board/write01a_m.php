...
function check_form(){
	...
	form.action = '<?=$boardRoot?>proc_m.php';
	form.submit();
}
							...
							<tr>
								<td>
									<div class="file_input">
										<input type="text" readonly title="File Route" id="file_route<?=$file_num?>" style="width:130px;padding:0 0 0 10px;">
...
?>
	...
	<tr>
		<td style='padding:5px 0px;'><textarea name="ment" id="ment" style='width:100%;height:300px;padding:10px;box-sizing:border-box;'><?=$ment?></textarea></td>
	</tr>
