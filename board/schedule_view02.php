<?
	...
	if($uid){
		...
		if($site=='재단'){
			$ment = str_replace("/smarteditor/upload/","http://ansanyouth.or.kr/smarteditor/upload/",$ment);
		}elseif($site=='상록'){
			$ment = str_replace("/smarteditor/upload/","http://sangnok.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='단원'){
			$ment = str_replace("/smarteditor/upload/","http://danwon.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='일동'){
			$ment = str_replace("/smarteditor/upload/","http://ildong.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}if($site=='사동'){
			$ment = str_replace("/smarteditor/upload/","http://sadong.ansanyouth.or.kr/smarteditor/upload/",$ment);
		}
...
<table cellpadding='0' cellspacing='0' border='0' width='100%'>
		...
		<td>
			...
			<table cellpadding='0' cellspacing='0' border='0' width='100%' class='gTable2'>
				...
				<tr> 
					...
					<th width='17%'>사용일자</th>
					<td width='33%'><?=$sData03?></td>
				</tr>

				<tr> 
					<th width='17%'>시간</th>
					<td width='33%'><?=$sData04?></td>
					<th width='17%'>사용인원</th>
					<td width='33%'><?=$sData05?></td>
				</tr>

				<tr> 
					<th width='17%'>결제수단</th>
					<td width='33%'><?=$sData06?></td>
					<th width='17%'>결제일</th>
					<td width='33%'><?=$sData07?></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td style='height:200px;border-bottom:1px solid #ccc;'><?=$ment?></td>
	</tr>
