		...
		for($i=1; $i<=$tot_num; $i++){
			...
			if($_FILES[$doc_name][name]){
				...
				if($fileUpload->uploadFile()){
					...
					if($engChk){
						Msg::backMsg('Please select the file again');
