	...
	<tr>
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class='gTable2'>
				...
				<tr align="" height='50'>							
					<th width="20%" class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">Application Number</th>
					<td class='bbs01' style="padding-left:2%; box-sizing:border-box;"><?=$title?></td>
				</tr>
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">Filing Date</th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;"><?=$data03?></td>
				</tr>
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">Registration Date</th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;"><?=$data04?></td>
				</tr>

				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">Title of the Invention</th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;"><?=$data05?></td>
				</tr>
<?
...
?>
				...
				<tr align="" height='50'>
					<th class='bbs' style="text-align:left; padding-left:2%; box-sizing:border-box;">Attachment#<?=$fno?></th>
					<td class='bbs' style="padding-left:2%; box-sizing:border-box;">
						<table cellpadding='0' cellspacing='0' border='0' width='100%'>
							...
							<?
								if($download_chk){
									if($UserOS=='pc'){
							?>
								<td width='80' align='right'><a href="javascript:file_down('FRM','<?=$file_num?>');" class='mini cbtn black'>Download</a></td>
							<?
									}else{
							?>
								<td width='80' align='right'><a href="javascript:file_down_m('<?=${'userfile'.$file_num}?>','<?=${'realfile'.$file_num}?>');" class='mini cbtn black'>Download</a></td>
							<?
									}
								}
							?>
...
?>
				...
				?>
					...
					<td width='60%' align='right'>
						<?=$btn_re_write?>
						<a href="javascript:reg_modify();" class='btn grn'>Edit</a>&nbsp;
						<a href="javascript:reg_del();" class='btn red'>Delete</a>&nbsp;
						<a href="javascript:reg_list();" class='btn blk'>Go back</a>
					</td>
