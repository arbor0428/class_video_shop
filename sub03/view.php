                ...
                <div class="detail_right">
                    <div class="pin_box">
                        ...
                        <ul class="choose_list_box price_detail_box">
                            <?php
                            $class_lists = sqlArray("SELECT c.* FROM ks_license_list l JOIN ks_class c ON l.class_uid=c.uid WHERE l.license_uid='$uid' ORDER BY l.sort");
                        ...
                        <ul class="price_detail_box02">
                            <?= price_view($row['price'], $row['discountPrice'], $row['discountRate'], $row['period']) ?>
                        </ul>
        ...
        <div class="detail_right pc_detail_wrap">
            <div class="pin_box">
                ...
                <div class="pin_two_btn_wrap dp_sb dp_c">
                    ...
                    <a class="pin_two_btn dp_f dp_c dp_cc bold2 wid100" href="" title="">
                        <img src="/images/sub/clip_icon_blk.svg" alt="클립">
                        <span>링크 복사하기</span>
                    </a>
                </div>
...
<script>
    ...
    // const class_uids = '<?= json_encode($class_uids, true) ?>';
