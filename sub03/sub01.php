      ...
      <div class="dp_f dp_wrap nVdSlickBox_04_wrap">
         <div class="nVdSlickBox">
            <a href="./view.php" title="">
               ...
               <div class="nVdCont">
                  <div class="nVdTop">
                     <p class="nVdtit01 bold2 dotdot">국제인증강사</p>
         ...
         <div class="nVdSlickBox">
            <a href="./view.php" title="">
               ...
               <div class="nVdCont">
                  <div class="nVdTop">
                     <p class="nVdtit01 bold2 dotdot">체형분석평가사</p>
                     <p class="nVdtit02 c_gry03 dotdot">멀리건 기법을 이용한 관절 유동술 빠른 치료 효과</p>
                     <ul class="clickicon dp_f dp_c">
                        <li class="dp_f dp_c">
                           <img src="/images/likeChk_gry.png" alt="">
         ...
         <div class="nVdSlickBox">
            <a href="./view.php" title="">
               ...
               <div class="nVdCont">
                  <div class="nVdTop">
                     <p class="nVdtit01 bold2 dotdot">필라테스지도자</p>
                     <p class="nVdtit02 c_gry03 dotdot">멀리건 기법을 이용한 관절 유동술 빠른 치료 효과</p>
                     <ul class="clickicon dp_f dp_c">
                        <li class="dp_f dp_c">
                           <img src="/images/likeChk_gry.png" alt="">
         ...
         <div class="nVdSlickBox">
            <a href="./view.php" title="">
               ...
               <div class="nVdCont">
                  <div class="nVdTop">
                     <p class="nVdtit01 bold2 dotdot">물리치료사 강사</p>
                     <p class="nVdtit02 c_gry03 dotdot">멀리건 기법을 이용한 관절 유동술 빠른 치료 효과</p>
                     <ul class="clickicon dp_f dp_c">
                        <li class="dp_f dp_c">
                           <img src="/images/likeChk_gry.png" alt="">
