        ...
        <div class="test_go_bot">
          <div class="gry04 test_gry_box">
            ...
            <div class="row dp_f dp_c">
              ...
              <div class="row_det">3회</div>
            </div>
            <div class="row dp_f dp_c">
              <div class="row_tit">영문 이름</div>
              <div class="row_det"><input type="text" value="iwebzone"></div>
            </div>
          </div>
          ...
          <div class="two_btn_wrap dp_f dp_c dp_cc">
              <a class="two_btn dp_f dp_c dp_cc bold2 bora01 c_w" href="./test_form.php" title="시험응시">
                시험 응시
              </a>
              <a class="two_btn dp_f dp_c dp_cc bold2 c_bora01" href="/mypage/sub08.php" title="다음에응시">
                다음에 응시
              </a>
          </div>
        </div>
