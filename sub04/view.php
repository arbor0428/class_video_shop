...
<form name="frm01" action="/mypage/order/" method="post">
    ...
    <input type="hidden" name="prod_type" value="best">
    <input type="hidden" name="userid" value="<?= $GBL_USERID ?>">
    <input type="hidden" name="numOfProd" value="<?= $has_cnt ?>">
    <input type="hidden" name="price" value="<?= $row['price'] ?>">
    <input type="hidden" name="discountPrice" value="<?= $row['discountPrice'] ?>">
    <input type="hidden" name="shippingFee" value="<?= $row['shippingFee'] ?>">
    <input type="hidden" name="good_mny" value="<?= $row['discountPrice'] ?>">
</form>
...
<script>
    ...
    const buy = function() {
        if (userid == '') {
            ...
            const class_uids = document.frm01['class_uids[]']
