...
<footer class="blue_gradient c_w">
    <div class="f_top01 bor_bot">
        <div class="c_center txt-c">
            ...
            <p class="f_top01_det">지속적인 서비스 품질개선에 적극 반영하여<br class="m_br"> 더 좋은 교육 컨텐츠로 보답하겠습니다.</p>
    ...
    <div class="f_bot01 bor_bot">
        <div class="c_center dp_sb dp_c">
            <ul class="f_bot01_menu dp_f">
                ...
                <li><a href="/termsUse.php" title="이용약관">이용약관</a></li>
                <li><a href="/privacyPolicy.php" title="개인정보처리방침">개인정보처리방침</a></li>
            </ul>
        ...
        <div class="c_center">
            ...
            <div class="dp_sb">
                <div class="f_bot02_left">
                    ...
                    <ul class="dp_f companyList second">
...
<script>
    ...
    // 썸네일 하트 찜하기
    const thumbWish = function(e) {
        const userid = '<?= $GBL_USERID ?>';
        const uid = e.dataset.id;
        $.ajax({
