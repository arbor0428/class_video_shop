		...
		<div class="s_cont">
			<div class="s_cont_tit">
				<ul class="s_cont_tabbtn dp_f">
					...
					<li><a href="/sub11/sub07.php">수강증 발급</a></li>
					<li><a href="/sub11/sub08.php">수료증 발급</a></li>
					<li class="on"><a href="/sub11/sub09.php">자격증 발급</a></li>
				</ul>
			</div>
				...
				<table class="subTbl">
					...
					<tbody>
						...
						<tr>
							<td>체형분석평가사 견관절 과정</td>
							<td>100%</td>
							<td><div class="testStatus on dp_f dp_c dp_cc certifi_printBtn">자격증 발급</div></td>
						</tr>
					</tbody>
				</table>
			</div>
...
<script>
	function tema(t){
		$('#cerPrintFrame').html("<iframe src='/sub09/certificate.php?uid="+t+"' name='' style='width:100%;height:710px;' frameborder='0' scrolling='auto'></iframe>");
		$('.cerPrint_open').click();
	}
