...
for ($i = 1; $i < 11; $i++) {
    $a1 = sqlRowOne("SELECT a1 FROM ks_exam WHERE class_uid='$class_uid' AND qnum='$i' ORDER BY qnum");
...
$row_arr = sqlArray("SELECT * FROM ks_exam WHERE class_uid=$class_uid ORDER BY qnum");
?>
    ...
    <div class="s_center">
        <div class="test_goBox">
            <div class="test_go_top bora01 dp_sb">
                ...
                <a class="test_closeBtn" href="/mypage/learning" title="뒤로가기">
            ...
            <div class="test_go_bot">
                ...
                <div class="gry04 test_gry_box">
                    ...
                    <div class="row dp_f dp_c">
                        ...
                        <div class="row_det"><?= $score ?>점 (<?= round($score / 10, 0) ?> / 10)</div>
                    </div>
                    <div class="row dp_f dp_c">
                    ...
                    <div class="test_quest wid100">
                        ...
                        ?>
                            <div class="quest_box">
                                ...
                                <ul class="quest_det">
                                    <li class="<? if ($row['a1'] == 1) echo "answer";
                                                if (!$isCorrect && ${'p' . $key} == 1) echo 'picked'; ?>">① <?= $row['q1'] ?></li>
                                    <li class="<? if ($row['a1'] == 2) echo "answer";
                                                if (!$isCorrect && ${'p' . $key} == 2) echo 'picked'; ?>">② <?= $row['q2'] ?></li>
                                    <li class="<? if ($row['a1'] == 3) echo "answer";
                                                if (!$isCorrect && ${'p' . $key} == 3) echo 'picked'; ?>">③ <?= $row['q3'] ?></li>
                                    <li class="<? if ($row['a1'] == 4) echo "answer";
                                                if (!$isCorrect && ${'p' . $key} == 4) echo 'picked'; ?>">④ <?= $row['q4'] ?></li>
                                </ul>
                            </div>
                        <? } ?>
                ...
                <div class="two_btn_wrap dp_f dp_c dp_cc">
                    <a class="two_btn dp_f dp_c dp_cc bold2 bora01 c_w" href="/mypage/learning/" title="확인">
                        확인
                    </a>
                </div>
            </div>
