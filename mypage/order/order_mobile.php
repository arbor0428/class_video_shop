...
<head>
    ...
    <link href="/module/kcp/static/css/style.css" rel="stylesheet" type="text/css" id="cssLink"/>
        ...
        function chk_pay()
        {
            ...
            {   
                if (pay_form.res_cd.value != "0000" )
                {
                    ...
                    location.href = "./index.php"; // 샘플에서는 거래등록 페이지로 이동
                }
            }
...
<body onload="chk_pay();">
            ...
            <div id="skipCont" class="contents">
                ...
                <ul class="list-type-1">
                    ...
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_tel1" value="<?= $buyr_tel1 ?>" />
                            </div>
                        </div>
                    </li>
                    <!-- 휴대폰번호(buyr_tel2) -->
                    <li>
                        ...
                        <div class="right">
                            <div class="ipt-type-1 pc-wd-2">
                                <input type="text" name="buyr_tel2" value="<?= $buyr_tel2 ?>" />
                            </div>
                        </div>
                    </li>
    ...
    <form name="pay_form" method="post" action="result.php">
