            ...
            <div class="m-navWrap">
                ...
                <div class="m-navbox on">
                    ...
                    <ul class="m-nav">
                        ...
                        <li>
                            <a href="/sub02/" title="이벤트">이벤트</a>
                        </li>
                        <li>
                            <a href="javascript:avoid(0);" title="자격증 과정">자격증 과정</a>
                            <span class="lnr lnr-chevron-down"></span>
                            <span class="lnr lnr-chevron-up"></span>
                            <ul class="m-depth2">
                        ...
                        <li>
                            <a href="javascript:avoid(0);" title="대면강의">대면강의</a>
                            <span class="lnr lnr-chevron-down"></span>
                            <span class="lnr lnr-chevron-up"></span>
                            <ul class="m-depth2">
                                <?
                                $f2f_arr = sqlArray("SELECT * FROM ks_best WHERE cade01=19");
                                ...
                                <? } ?>
                                <!-- <li><a href="" title="대학중점연구소">대학중점연구소</a></li>
                                <li><a href="" title="연구센터(사업단)">연구센터(사업단)</a></li>
                                <li><a href="" title="일반연구소">일반연구소</a></li>
                                <li><a href="" title="광운대 기술지주회사">광운대 기술지주회사</a></li> -->
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:avoid(0);" title="홈트">홈트</a>
                            <span class="lnr lnr-chevron-down"></span>
                            <span class="lnr lnr-chevron-up"></span>
                            <ul class="m-depth2">
                        ...
                        <li>
                            <a href="javascript:avoid(0);" title="스토어">스토어</a>
                            <span class="lnr lnr-chevron-down"></span>
                            <span class="lnr lnr-chevron-up"></span>
                            <ul class="m-depth2">
                        ...
                        <li>
                            <a href="/sub08/" title="강의후기">강의후기</a>
                        </li>
                        <!-- <li>
