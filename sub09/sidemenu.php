...
<div class='sidemenu'>
	...
	<ul class="sidemenu_list">
		...
		<li class='<?=$side[1]?>'><a href='/sub09/sub01.php'>맞춤 강좌</a></li>
		<li class='<?=$side[2]?>'><a href='/sub09/sub02.php'>알림</a></li>
	</ul>
	<ul class="sidemenu_list">
		<li class="c_gry04 f14">학습 관리</li>
		<li class='<?=$side[3]?>'><a href='/sub09/sub03.php'>수강중인 강좌</a></li>
		<li class='<?=$side[4]?>'><a href='/sub09/sub04.php'>찜한 강좌</a></li>
		<li class='<?=$side[5]?>'><a href='/sub09/sub05.php'>나의 학습질문</a></li>
