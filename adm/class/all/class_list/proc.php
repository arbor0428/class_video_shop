...
switch ($type) {
    ...
    case 'WRITE':
        ...
        for ($i = 0; $i < count($kollus_video_id); $i++) {
            ...
            sqlExe("UPDATE ks_class_list SET kollus_video_id='$_kollus_video_id', title='$_title', exp='$_exp', length='$_length' WHERE class_uid='$uid' AND sort='$_sort'");
        }
        $msg = "저장되었습니다.";
        Msg::goMsg($msg, "/adm/class/all/");
        break;
    default:
