...
switch ($type) {
    ...
    case 'edit':
        ...
        if ($type == 'write') {
            ...
            $query = "INSERT INTO ks_class (status, cade01, cade02, tuid, title, exp, target, period, price, discountPrice, discountRate, ment01, ment02, upfile01, realfile01, userip, rTime) VALUES";
            $query .= " (0, '$cade01', '$cade02', '$tuid', '$title', '$exp', '$target', '$period', '$price', '$discountPrice', '$discountRate', '$ment01', '$ment02', '$arr_new_file[1]', '$real_name[1]', '$userip', '$rTime')";
