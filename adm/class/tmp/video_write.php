			...
			<td>
				<table cellpadding='0' cellspacing='0' border='0' width='100%' class='gTable'>
					...
					<tr>
						<th><?= $chk_icon01 ?> 영상</th>
					    <td width=''>
                            <input type="hidden" name="media_content_key" id="media_content_key" class="form-control " value="<?= $media_content_key ?>" readonly>
                            <input type="hidden" name="kollus_video_id" id="kollus_video_id" class="form-control " value="<?= $kollus_video_id ?>" readonly>
                            <input type="text" name="kollus_video_filename" id="kollus_video_filename" class="form-control " value="<?= $kollus_video_filename ?>" readonly>
                            <a href="javascript:void(0)" class="small cbtn bora" onclick="formModal()">영상 선택</a>
                        </td>
					</tr>
					<tr>
