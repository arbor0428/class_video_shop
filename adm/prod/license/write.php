...
<form name='frm01' class="user" method='post' ENCTYPE="multipart/form-data">
    ...
    <div class="tbl-st">
        ...
        <div class="cols">
            ...
            <div class="cols_40 cols_">
                <div class="form-group">
                    ...
                    <!-- <select type="text" name="cade01" id="cade01" class="form-control" value=""> -->
        ...
        <div class="cols">
            ...
            <div class="cols_5 cols_ th"><span class='eqc'>*</span>자격증<br>타입</div>
            <div class="cols_15 cols_">
                <div class="form-group">
                    <select name="prod_type" id="prod_type" disabled>
                        <option value="LICENSE_ONLINE" <? if ($prod_type == "LICENSE_ONLINE") echo "selected"; ?>>온라인</option>
                        <option value="LICENSE_OFFLINE" <? if ($prod_type == "LICENSE_OFFLINE") echo "selected"; ?>>오프라인</option>
                    </select>
                </div>
            </div>
        </div>
...
<script>
    ...
    const form_confirm = function() {
        ...
        document.frm01.prod_type.disabled = false
    ...
    const getCade = function(input) {
        ...
        if (cade01 == "") {
            ...
            document.frm01.prod_type[0].selected = true
            return
        } else {
            document.frm01.prod_type[1].selected = true
