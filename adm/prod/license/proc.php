...
switch ($type) {
    ...
    case 'edit':
        ...
        if ($type == 'write') {
            ...
            $query = "INSERT INTO ks_license (status, prod_type, cade01, cade02, title, eng_title, exp, target, price, discountPrice, discountRate, ment01, upfile01, realfile01, userip, rTime) VALUES";
            $query .= " (0, '$prod_type', '$cade01', '$cade02', '$title', '$eng_title', '$exp', '$target', '$price', '$discountPrice', '$discountRate', '$ment01', '$arr_new_file[1]', '$real_name[1]', '$userip', '$rTime')";
