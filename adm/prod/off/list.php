...
//쿼리조건
$query_ment = "where prod_type='OFFLINE'";
...
$teacher_ment = ", (SELECT name FROM ks_member WHERE ks_member.uid=ks_class.tuid) AS tname";

$query = "SELECT * $teacher_ment FROM ks_class $query_ment $sort_ment";
