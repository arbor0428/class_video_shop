    ...
    if ($total_record != '0') {
        if ($total_record > $record_count) {
            ...
            if ($total_page > 1 && ($record_start != 0)) {
                ...
                echo ("<a href=javascript:pageNum('$fName','$pre_page_start'); class='direction'>＜</a> ");
            } else {
                echo ("<a href=javascript:pageNum('$fName','$pre_page_start'); class='direction'>＜</a> ");
            }
            ...
            if ($total_page > 1 && ($record_start != ($total_page * $record_count - $record_count))) {
                ...
                echo ("<a href=javascript:pageNum('$fName','$next_page_start'); class='direction'>＞</a> ");
            } else {
